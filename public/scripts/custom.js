...
$( document ).ready(function() {
    function init_template(){//Class is vital to run AJAX Pages
        ...
        $('.open-submenu, .page-navigation a').click(function(){
            $('.open-submenu').find('i').toggleClass('rotate-submenu');
            $('.page-navigation').toggleClass('navigation-active');
        });
        
        $('#content').click(function(){
            $('.open-submenu').find('i').removeClass('rotate-submenu');
            $('.page-navigation').removeClass('navigation-active');
        });
        ...
        $('#content').on('scroll', function () {
            ...
            var inside_header = ($(this).scrollTop() <= 50);
            var passed_header = ($(this).scrollTop() >= 0); //250
            var footer_reached = ($(this).scrollTop() >= (total_scroll_height - ($(window).height() +100 )));

            if (inside_header == true) {
                $('.back-to-top-badge').removeClass('back-to-top-badge-visible');
                $('.homepage-header').addClass('transparent-header');
            } else if (passed_header == true)  {
                $('.homepage-header').removeClass('transparent-header');
        ...
        function dual_sidebar(){
            ...
            $('.menu-item, .page-navigation a').click(function(){snapper.close();});
    ...
    setTimeout(init_template, 50);//Activating all the plugins
    ...
    $(function(){
      ...
      var options = {
        ...
        onAfter: function($container, $newContent) {
            setTimeout(init_template, 50)//Timeout required to properly initiate all JS Functions. 
